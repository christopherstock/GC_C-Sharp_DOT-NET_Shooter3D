/*  $Id: CeilingFace.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A ceiling.
 */
...
{
    public class CeilingFace : WallFace
    {
        public CeilingFace( float initX, float initY, float initZ, float initWidth, float initHeight, int initTextureID, float initTilingX, float initTilingY ) : base( ref initTilingX, ref initTilingY, initWidth, initHeight )
        {
            textureID  = initTextureID;
            vertices   = new Vertex[]
            {
                new Vertex ( initX,             initY, initZ + initHeight,  0.0f,           initTilingY ),
                new Vertex ( initX + initWidth, initY, initZ + initHeight,  initTilingX,    initTilingY ),
