/*  $Id: RearWallFace.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A front-wall.
 */
...
{
    public class RearWallFace : WallFace
    {
        public RearWallFace( float initX, float initY, float initZ, float initWidth, float initHeight, int initTextureID, float initTilingX, float initTilingY ) : base( ref initTilingX, ref initTilingY, initWidth, initHeight )
        {
            ...
            vertices  = new Vertex[]
            {
                ...
                new Vertex ( initX + initWidth,     initY + initHeight,     initZ,      0.0f,           initTilingY     ),
