/*  $Id: AscendingFront.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A house.
 */
...
{
    public class AscendingFront : Mesh
    {
        public AscendingFront
        (
            float   posX,
            float   posY,
            float   posZ,
        ...
        (
            new Face[]
            {
                new AscendingFrontWallFace( posX, posY, posZ, width, height, depth, texture, textureTilingX, textureTilingY ),
            },
            posX,
            posY,
            posZ,
        ...
        )
        {
            ...
            specialFeature = Mesh.SPECIAL_FEATURE_ASCENDING_FRONT;
