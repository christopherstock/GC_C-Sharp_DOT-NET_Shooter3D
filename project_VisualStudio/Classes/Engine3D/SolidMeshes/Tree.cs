/*  $Id: Tree.cs,v 1.2 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A house.
 */
...
namespace Classes.Engine3D.SolidMeshes
{
    public class Tree : Mesh
    {
        ...
        base
        (
            MeshData.getMeshData( MeshData.MESH_TREE, posX, posY, posZ ),
            posX,
            posY,
            posZ,
            0.0f,
...
/*
 *  $Log: Tree.cs,v $
 *  Revision 1.2  2006/11/17 06:46:14  jenetic.bytemare
 *  safe
 *
