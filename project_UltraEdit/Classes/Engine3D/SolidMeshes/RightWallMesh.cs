/*  $Id: RightWallMesh.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A front-wall.
 */
...
{
    public class RightWallMesh : Mesh
    {
        public RightWallMesh
        (
            float   posX,
            float   posY,
            float   posZ,
        ...
        (
            new Face[]
            {
                new RightWallFace(  posX, posY, posZ, width, height, textureID, tilingX, tilingY ),
            },
            posX,
            posY,
            posZ,
        ...
        )
        {
            ...
            (
                new PointF[]
                {
                    ...
                    new PointF( 1000 * posX,                1000 * ( posZ + width )     ),
                    new PointF( 1000 * ( posX + 0.001f ),   1000 * ( posZ + width )     ),
                    new PointF( 1000 * ( posX + 0.001f ),   1000 * posZ                 ),
                }
            );
