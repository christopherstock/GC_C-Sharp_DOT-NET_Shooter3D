/*  $Id: Wall.cs,v 1.3 2006/10/09 17:26:22 jenetic.bytemare Exp $
 *  =================================================================================
 *  Abstract class Wall.
 */
...
{
    public abstract class Wall : SolidFace
    {
        public Wall( ref float initTilingX, ref float initTilingY, float initWidth, float initHeight, float initDepth ) : base( 0, null, null )
        {
