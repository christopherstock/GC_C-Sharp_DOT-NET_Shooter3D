/*  $Id: Ceiling.cs,v 1.3 2006/10/09 17:26:21 jenetic.bytemare Exp $
 *  =================================================================================
 *  A ceiling.
 */
...
{
    public class Ceiling : Wall
    {
        public Ceiling( float initX, float initY, float initZ, float initWidth, float initHeight, float initDepth, int initTextureID, float initTilingX, float initTilingY ) : base( ref initTilingX, ref initTilingY, initWidth, initHeight, initDepth )
        {
