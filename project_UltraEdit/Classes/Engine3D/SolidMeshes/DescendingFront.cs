/*  $Id: DescendingFront.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A house.
 */
...
{
    public class DescendingFront : Mesh
    {
        public DescendingFront
        (
            float   posX,
            float   posY,
            float   posZ,
        ...
        (
            new Face[]
            {
                new DescendingFrontWallFace( posX, posY, posZ, width, height, depth, texture, textureTilingX, textureTilingY ),
            },
            posX,
            posY,
            posZ,
        ...
        )
        {
            ...
            //specify the special region as a graphics-path!
            ...
            specialRegion = new Region( graphicsPath );
            specialFeature = Mesh.SPECIAL_FEATURE_DESCENDING_FRONT;
 ...
 *  no message
 *
 *  Revision 1.1  2006/10/09 17:27:10  jenetic.bytemare
