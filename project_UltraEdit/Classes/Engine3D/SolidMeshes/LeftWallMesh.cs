/*  $Id: LeftWallMesh.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A front-wall.
 */
...
{
    public class LeftWallMesh : Mesh
    {
        public LeftWallMesh
        (
            float   posX,
        ...
        (
            new Face[]
            {
                new LeftWallFace(  posX, posY, posZ, width, height, textureID, tilingX, tilingY ),
            },
            posX,
            posY,
            posZ,
