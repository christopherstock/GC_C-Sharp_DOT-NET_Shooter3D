/*  $Id: FloorMesh.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A house.
 */
...
namespace Classes.Engine3D.SolidMeshes
{
    public class FloorMesh : Mesh
    {
        ...
        (
            new Face[]
            {
                new FloorFace(      posX,   posY,   posZ,   width,  height,  texture,     textureTilingX,     textureTilingY         ),
            },
            posX,
            posY,
            posZ,
