/*  $Id: RightWallFace.cs,v 1.1 2006/11/17 06:46:14 jenetic.bytemare Exp $
 *  =================================================================================
 *  A left wall.
 */
...
{
    public class RightWallFace : WallFace
    {
        public RightWallFace( float initX, float initY, float initZ, float initWidth, float initHeight, int initTextureID, float initTilingX, float initTilingY ) : base( ref initTilingX, ref initTilingY, initWidth, initHeight )
        {
